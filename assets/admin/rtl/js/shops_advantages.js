    ...
    var Shops_advantages = function () {
        ...
        var handleRecords = function () {
            ...
            Hotels_advantages_grid = $('.dataTable').dataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": config.admin_url + "/shops_advantage/data",
                    "type": "POST"
                },
                "columns": [
//                    {"data": "user_input", orderable: false, "class": "text-center"},
        ...
        var handleSubmit = function () {
            ...
            $('#addEditShopsAdvantagesForm').validate({
                rules: {
                    title_ar: {
                        required: true
            ...
            $('#addEditHotelsAdvantagesForm').submit(function () {
                var id = $('#id').val();
                var action = config.admin_url + '/shops_advantage/add';
                if (id != 0) {
                    action = config.admin_url + '/shops_advantage/edit';
                }
        ...
        return {
            ...
            edit: function (t) {
                ...
                App.editForm({
                    element: t,
                    url: config.admin_url + '/shops_advantage/row',
                    ...
                    buttons: {
                        confirm: {
                            ...
                            action: function () {
                                App.deleteForm({
                                    element: t,
                                    url: config.admin_url + '/shops_advantage/delete',
                                    data: {id: $(t).attr("data-id")},
                                    success: function (data)
                                    {
                                        $.alert(data.message);
