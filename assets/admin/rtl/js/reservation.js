    ...
    var Reservation = function () {
        ...
        var handleRecords = function () {
            //alert('d');
            Reservation_grid = $('.dataTable').dataTable({
                //"processing": true,
                "serverSide": true,
                "ajax": {
                    "url": config.admin_url + "/reservation/data",
                    "type": "POST"
                },
                "columns": [
//                    {"data": "user_input", orderable: false, "class": "text-center"},
        ...
        return {
            ...
            print_reservation: function (ele) {
                var action = config.admin_url + '/reservation/print_reservation';
                $.ajax({
                    url: action,
                    data: {
                        reservation_id: $(ele).data('id'),
                        program_flight_id: $(ele).data('program-flight-id'),
                    },
                    async: false,
                    success: function (data) {
                        print_div(data);
