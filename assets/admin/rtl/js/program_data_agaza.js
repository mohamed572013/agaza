    ...
    var Program_data = function () {
        ...
        var getCities = function (country_id, city_id, content) {
            $.ajax({
                type: "post",
                url: config.admin_url + '/program_agaza/getCities',
                data: {
        ...
        var getHotels = function (city_id, selected_id, content) {
            $.ajax({
                type: "post",
                url: config.admin_url + '/program_agaza/getHotels',
                data: {
                    city_id: city_id,
            ...
            $(document).on('change', '#program_id', function () {
                ...
                if ($('.table-box').hasClass('active')) {
                    ...
                    if (id == 'program_cities_table') {
                        Program_cities_grid.ajax.url(config.admin_url + "/program_cities_agaza/data/" + program_id).load();
                    }
                    if (id == 'program_flights_table') {
                        Program_flights_grid.ajax.url(config.admin_url + "/program_flights_agaza/data/" + program_id).load();
                    }
                    ...
                    if (id == 'program_extra_services_table') {
                        Program_extra_services_grid.ajax.url(config.admin_url + "/program_extra_services_agaza/data/" + program_id).load();
                    }
                    if (id == 'program_advantages_table') {
                        Program_advantages_grid.ajax.url(config.admin_url + "/program_advantages_agaza/data/" + program_id).load();
                    }
                ...
                if (box_type == 'program_cities') {
                    ...
                    if (typeof Program_cities_grid === 'undefined') {
                        ...
                        Program_cities_grid = $('#program_cities_table .dataTable').DataTable({
                            ...
                            "serverSide": true,
                            "ajax": {
                                "url": config.admin_url + "/program_cities_agaza/data/" + program_id,
                                "type": "POST"
                            },
                            "columns": [
                ...
                if (box_type == 'program_flights') {
                    ...
                    if (typeof Program_flights_grid === 'undefined') {
                        ...
                        Program_flights_grid = $('#program_flights_table .dataTable').DataTable({
                            ...
                            "serverSide": true,
                            "ajax": {
                                "url": config.admin_url + "/program_flights_agaza/data/" + program_id,
                                "type": "POST"
                            },
                            "columns": [
//                    {"data": "user_input", orderable: false, "class": "text-center"},
                ...
                if (box_type == 'program_rooms_prices') {
                    ...
                    if (typeof Program_rooms_prices_grid === 'undefined') {
                        ...
                        Program_rooms_prices_grid = $('#program_rooms_prices_table .dataTable').DataTable({
                            ...
                            "serverSide": true,
                            "ajax": {
                                "url": config.admin_url + "/program_rooms_prices_agaza/data/" + programs_flights_id,
                                "type": "POST"
                            },
                            "columns": [
//                    {"data": "user_input", orderable: false, "class": "text-center"},
                        ...
                        Program_rooms_prices_grid.ajax.url(config.admin_url + "/program_rooms_prices_agaza/data/" + programs_flights_id).load();
                    }
                }
                if (box_type == 'program_extra_services') {
                    ...
                    if (typeof Program_extra_services_grid === 'undefined') {
                        ...
                        Program_extra_services_grid = $('#program_extra_services_table .dataTable').DataTable({
                            ...
                            "serverSide": true,
                            "ajax": {
                                "url": config.admin_url + "/program_extra_services_agaza/data/" + program_id,
                                "type": "POST"
                            },
                            "columns": [
//                    {"data": "user_input", orderable: false, "class": "text-center"},
