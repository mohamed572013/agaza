...
//            alert(adult_num);
            ...
            $("select[id^='room_num']").each(function () {
                ...
                var room_type = $(this).data('room-title');
                var room_cost = (room_num * no_of_bed_in_room) * room_price;
                if (room_num > 0) {
                    calculatePrice(room_id, room_cost);
            ...
            if (adult_num == count && count != 0) {
                ...
                $('.alert-message').html(lang.room_num_validate);
                $('.alert-message').show(1000);
                next = false;
            }
...
//                    alert(parseInt(child_price) * parseInt(childs_num));
