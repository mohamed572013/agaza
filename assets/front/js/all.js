    ...
    $(function () {
        ...
        if ($(window).width() < 768) {
            ...
            $('.click-tabs').on("click", function () {
                ...
                $(".click-tabs-mahmoud").each(function () {
                    var maIndex = $(this).attr("title");
                    $(this).removeClass('active');
                    $(this).removeClass('in');
                    $("." + maIndex).removeClass('active');
                    $(".".maIndex).removeClass('in');
...
$('#iframeId').contents().find('html').html("<h1 style='text-align: center;'>This IS an iframe</h1>");

$( '.hcsb_citySearch' ).each(function () {
    this.style.setProperty( 'color', '#fff', 'important' );
});

$( '.grid label' ).each(function () {
    this.style.setProperty( 'float', 'right', 'important' );
});


$("iframe").contents().find("body").css("display", "none");

$("#iframeId").contents().find(".grid label").css('float', 'right');