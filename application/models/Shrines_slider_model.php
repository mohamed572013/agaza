<?php
    ...
    class Shrines_slider_model extends CI_Model{

        private $_table = 'shrines_slider';
        public $images_dimensions = array(
            's' => array('width' => '208', 'height' => 115),
        ...
        public function do_upload($image, $config, $new_path){
            ...
            if (!$this->upload->do_upload($image)) {
                ...
                $file_resized_name = resize5($data, $new_path, $this->images_dimensions, false);
