<?php
    ...
    class Program_data_model extends CI_Model{
        ...
        private $cities_hotels_table = 'programs_cities';
        ...
        public function allPrograms($branches_id){
            $this->db->select('*');
            $this->db->from($this->_table);
        ...
        public function getSumNightsOfProgram($program_id, $program_cities_id = false){
            $this->db->select('sum(nights) as nights');
            $this->db->from($this->cities_hotels_table);
            if ($program_cities_id) {
                $this->db->where('id !=', $program_cities_id);
            }
