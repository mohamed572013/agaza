...
$config['modules']['owner']['main'] = array(
    'admin', 'user_management', 'basic_data', 'hotelss', 'flight', 'settings', 'visas',
...
$config['modules']['owner']['sub'] = array(
    ...
    'visa_periods', 'visa_jobs', 'visa_documents', 'visa_create', 'visas_reservation', 'etiquette', 'shops_tag', 'restaurants_tag',
    'reservation', 'home_slider', 'islamic_programs', 'islamic_data', 'islamic_program_categories', 'mnasek', 'documents', 'intro', 'islamic_hotels', 'islamic_hotel_data', 'program_agaza', 'clients', 'shops', 'transportations', 'shops_features', 'brands', 'shops_advantage', 'restaurants_advantage', 'restaurants', 'islamic_hotels_reservation'
);
$config['modules']['super admin']['main'] = array(
    'admin', 'user_management', 'basic_data', 'hotels', 'flight', 'settings', 'visas',
    'programms', 'agazabook', 'others', 'restaurantss', 'shopss', 'transportationss', 'explore_egyptt'
);
$config['modules']['super admin']['sub'] = array(
    ...
    'visa_periods', 'visa_jobs', 'visa_documents', 'visa_create', 'restaurants_advantage', 'restaurants', 'visas_reservation', 'program_agaza', 'clients', 'shops', 'transportations', 'shops_features', 'brands', 'shops_advantage', 'islamic_hotels_reservation'
        //'chalets_others', 'haj_umrah_programs', 'haj_umrah_program', 'haj_umrah_hotels',
);

$config['modules']['admin']['main'] = array(
    'branches'
);
$config['modules']['admin']['sub'] = array(
    'branches'
);
