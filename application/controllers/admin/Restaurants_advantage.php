<?php
    ...
    class Restaurants_advantage extends C_Controller{
        public function __construct(){
            parent::__construct();
            $this->load->model('Restaurants_advantage_model', 'hotels_advantage');
        }

        public function index(){            
            $main_content = 'restaurant_advantages/index';
        ...
        function data(){
            ...
            $this->datatables->add_column('options', function($data) {
                ...
                $back .= '<a href="#" title="' . _lang("edit") . '" class="tooltips" onclick="Restaurants_advantages.edit(this);return false;" data-id="' . $data["id"] . '"><i class="fa fa-2x fa-edit"></i></a>';
                $back .= "&nbsp;&nbsp;";
                ...
                class="tooltips"
                data-id="' . $data["id"] . '"
                onclick="Restaurants_advantages.delete(this);return false;"><i class="fa fa-times fa-2x text-danger"></i></a>';
