<?php
    ...
    class Restaurants_tag extends C_Controller{
        public function __construct(){
            parent::__construct();
            $this->load->model('Restaurants_tag_model', 'restaurant_tag');
        }

        public function index(){            
            $main_content = 'restaurant_tags/index';
        ...
        public function row(){
            // pri($_POST);
            $id = $_POST['id'];
            $find = $this->restaurant_tag->find($id);
        ...
        public function add(){
            ...
            if ($this->form_validation->run() == false) {
                ...
                //pri($data_array);
                $add = $this->restaurant_tag->add($data_array);
                if ($add) {
        ...
        public function edit(){
            ...
            if ($this->form_validation->run() == false) {
                ...
                $where_array['id'] = $id;
                //pri($data_array);
                $update = $this->restaurant_tag->update($data_array, $where_array);
                if ($update) {
        ...
        public function delete(){
            $id = $_POST['id'];
            $where_array['id'] = $id;
            $deleted = $this->restaurant_tag->delete($where_array);
            if ($deleted) {
        ...
        function data(){
            ...
            $this->datatables->add_column('options', function($data) {
                ...
                $back .= '<a href="#" title="' . _lang("edit") . '" class="tooltips" onclick="Restaurants_tags.edit(this);return false;" data-id="' . $data["id"] . '"><i class="fa fa-2x fa-edit"></i></a>';
                $back .= "&nbsp;&nbsp;";
                ...
                class="tooltips"
                data-id="' . $data["id"] . '"
                onclick="Restaurants_tags.delete(this);return false;"><i class="fa fa-times fa-2x text-danger"></i></a>';
        ...
        public function titles_check($titles = array(), $id = false){
            ...
            foreach ($titles as $key => $title) {
                ...
                $find = $this->restaurant_tag->findTitle($where_array);
                //pri($find);
                if ($find) {
