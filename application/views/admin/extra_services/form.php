                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?= $lang['add'] . " " . $lang['extra_services']; ?></h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <?php } ?>
                            <!--Table Wrapper Start-->
                            <form action="<?= \base_url('admin/extra_services') . $action; ?>" method="post" class="form-horizontal ls_form form-horizontal ls_form bv-form">
                                ...
                                $person_or_card[0] = "فرد";
                                $person_or_card[1] = "استمارة";
                                if (!isset($edit->person_or_card)) {
                                    $person_or_card_val = 1;
                                } else {
                                    $person_or_card_val = $edit->person_or_card;
                                }
                                ?>
                                ...
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 col-md-2 col-lg-2 control-label text-capitalize"><?= $lang['type']; ?></label>
                                    <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
                                        <?php echo form_dropdown('person_or_card', $person_or_card, $person_or_card_val, 'class="form-control"') ?>
                                    </div>
                                </div>
