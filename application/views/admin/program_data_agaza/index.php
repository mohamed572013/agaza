        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" class="form-horizontal" id="addEditProgramsFlightsForm"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label text-capitalize">السعر للبالغ</label>
                        <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
                            <input type="text" class="form-control" id="f_adult_price" name="f_adult_price">
                            <div class="help-block"></div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="<?= base_url('admin/program_data/show'); ?>"><?= _lang('program_data'); ?></a></li>
                    </ol>
                    <!--Top breadcrumb start -->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?= _lang('program_data') ?></h3>
                        </div>
                        <style>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                    <select class="form-control program-select-2" name="program_id" id="program_id">
                                        <option disabled="disabled"
                                                selected>اختر</option>
                            ...
                            <div class="ls-editable-table table-responsive ls-table table-box disabled" style="padding-top: 30px;" id="program_extra_services_table">
                                <a href="" class="btn btn-primary" style="margin:0 15px 30px;" onclick="Program_data.add_extra_services(); return false;">اضافة جديد</a>
                                <table class="table table-bordered table-striped table-bottomless dataTable">
                                    <thead>
                                        <tr>
                            ...
                            <div class="ls-editable-table table-responsive ls-table table-box disabled" style="padding-top: 30px;" id="program_advantages_table">
                                <a href="" class="btn btn-primary" style="margin:0 15px 30px;" onclick="Program_data.add_advantages(); return false;">اضافة جديد</a>
                                <table class="table table-bordered table-striped table-bottomless dataTable">
                                    <thead>
                                        <tr>
                                            <th>الاسم</th>
                            ...
                            <div class="ls-editable-table table-responsive ls-table table-box disabled" style="padding-top: 30px;" id="chalets_others_prices_table">
                                <a href="" class="btn btn-primary" style="margin:0 15px 30px;" onclick="Program_data.add_chalets_others_prices(); return false;">اضافة جديد</a>
                                <table class="table table-bordered table-striped table-bottomless dataTable">
                                    <thead>
                                        <tr>
                                            <th><?= _lang('المنطقة') ?></th>
