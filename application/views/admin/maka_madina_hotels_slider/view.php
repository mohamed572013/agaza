<?php
$hotels_id = \xss_clean($this->uri->segment(4));
?>
...
<section id="min-wrapper">
    <div id="main-content">
        <div class="container-fluid">
            ...
            <a class="btn btn-sm btn-info pull-right" href="<?= \base_url("admin/maka_madina_hotels_slider/add/$hotels_id") ?>"><?= $lang['add_new']; ?> </a>
            <br>
            <br>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?= $lang['maka_madina_hotels_slider']; ?></h3>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($page_list as $page_key => $page) {
                                            ...
                                            <tr id="tr_<?= $page->id; ?>">
                                                ...
                                                <td><?= $page->title_ar; ?></td>
                                                 <td><img src="<?php echo \base_url("uploads/maka_madina_hotels_slider/$page->image") ?>" class="img-responsive" style="width: 100px"/> </td>

                                                <td class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                                    <a class="btn btn-xs btn-warning" title="<?= $lang['edit']; ?>" href="<?= \base_url('admin/maka_madina_hotels_slider/edit') . '/' . $page->id; ?>"><i class="fa fa-pencil-square-o"></i> </a>
...
<script>
    ...
    function delete_item_masa(title, id) {
        $.ajax({
            type: "post",
            url: "<?= base_url("admin/maka_madina_hotels_slider/delete") ?>" + "/" + id,
    ...
    function state_action_masa(title, id) {
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url("admin/maka_madina_hotels_slider/status") ?>" + "/" + id,
            success: function (data) {
                if (data == "yes") {
                    $.amaran({
                        content: {
                    ...
                    $.amaran({
                        content: {
                            message: '<b> فشل فى  تغيير حالة  الصورة</b>',
                            size: title,
                            file: '<b> </b>',
                            icon: 'fa fa-times'
                        },
