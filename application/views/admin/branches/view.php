...
<section id="min-wrapper">
    <div id="main-content">
        <div class="container-fluid">
            ...
            <a class="btn btn-sm btn-info pull-right" href="<?= \base_url("admin/branches/add") ?>"><?= $lang['add_new']; ?> </a>
            <br>
            <br>
            <div class="row">
                <div class="col-md-12">
                                        ...
                                        <?php
                                            ...
                                            foreach ($page_list as $page_key => $page) {
                                                ...
                                                <tr id="tr_<?= $page->id; ?>">
                                                    ...
                                                    <td><?= $page->code; ?></td>
                                                    <td><?= $page->title_ar; ?></td>
                                                    <td><?= $page->parent_company; ?></td>
                                                    <td><?= $page->money_limit; ?></td>
                                                    <td> <a href="<?= \base_url('admin/departments/show') . '/' . $page->id; ?>"><?= $lang['departments']; ?></a></td>

                                                    <td class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                                        <a class="btn btn-xs btn-warning" title="<?= $lang['edit']; ?>" href="<?= \base_url('admin/branches/edit') . '/' . $page->id; ?>"><i class="fa fa-pencil-square-o"></i> </a>
...
<script>
                                                        ...
                                                        function delete_item_masa(title, id) {
                                                            $.ajax({
                                                                type: "post",
                                                                url: "<?= base_url("admin/branches/delete") ?>" + "/" + id,
                                                        ...
                                                        function state_action_masa(title, id) {
                                                            ...
                                                            $.ajax({
                                                                type: "post",
                                                                url: "<?= base_url("admin/branches/status") ?>" + "/" + id,
                                                                success: function (data) {
                                                                    if (data == "yes" || data == "	yes") {
                                                                        $.amaran({
                                                                            content: {
                                                                        ...
                                                                        $.amaran({
                                                                            content: {
                                                                                message: '<b> فشل فى  تغيير حالة  الفرع</b>',
                                                                                size: title,
                                                                                file: '<b> </b>',
                                                                                icon: 'fa fa-times'
                                                                            },
