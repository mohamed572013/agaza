...
<section id="min-wrapper">
    <div id="main-content">
        <div class="container-fluid">
            ...
            <a class="btn btn-sm btn-info pull-right" href="<?= \base_url("admin/maka_madina_shrines/add") ?>"><?= $lang['add_new']; ?> </a>
            <br>
            <br>
            <div class="row">
                <div class="col-md-12">
										...
										<?php
											...
											if (count($page_list) > 0) {
												foreach ($page_list as $page_key => $page) {
													...
													$city= $this->maka_madina_shrines->GetWhere("places", "id", "ASC", $cond);
													...
													<tr id="tr_<?= $page->id; ?>">
														...
														<td class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
															<a class="btn btn-xs btn-warning" title="<?= $lang['edit']; ?>" href="<?= \base_url('admin/maka_madina_shrines/edit') . '/' . $page->id; ?>"><i class="fa fa-pencil-square-o"></i> </a>
