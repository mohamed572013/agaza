<?php
    if (isset($edit->places_id)) {
        ...
        $country = $this->maka_madina_hotels->GetWhere("places", "id", "ASC", $cond_emp);
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="<?= \base_url('admin/maka_madina_hotels/show') ?>"><?= $lang['maka_madina_hotels']; ?></a></li>
                    </ol>
                    <!--Top breadcrumb start -->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?= $lang['edit'] . " " . $lang['maka_madina_hotels']; ?></h3>
                        </div>
                        <div class="panel-body">
                            <?php if (!empty($error)) { ?>
                                ...
                                <?php } ?>
                            <!--Table Wrapper Start-->
                            <form  enctype="multipart/form-data"  action="<?= \base_url('admin/maka_madina_hotels') . $action; ?>" method="post" class="form-horizontal ls_form form-horizontal ls_form bv-form">
                                ...
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 col-md-2 col-lg-2 control-label text-capitalize">Stars</label>
                                    <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
                                        <?php echo form_dropdown('stars', $stars, $stars_val, 'class="form-control"') ?>
                                    </div>
                                </div>
                                ...
                                <?php if (isset($edit->image)) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
                                                ...
                                                <img src="<?php echo base_url('uploads/maka_madina_hotels/' . $edit->image); ?>" width="200" height="100" />
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-12"> <label class=" control-label"><?= $lang['hotels_advantage'] ?></label><div>
                                        <div class="col-lg-12">
                                            <?php
                                                if (isset($edit->hotels_advantage_ids)) {
                                                    $hotels_advantage_ids = $edit->hotels_advantage_ids;
                                                } else {
                                                    $hotels_advantage_ids = "";
                                                }
                                                ...
                                                foreach ($hotels_advantage as $value) {
                                                    ...
                                                    <div class=" col-lg-4">
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <input type='checkbox' name='hotels_advantage_ids[]'  class="icheck-blue main_all<?= $value->id ?>" value='<?= $value->id ?>' <?php if (in_array($value->id, $hotels_advantage_ids)) echo "checked" ?>   style="float: right;margin: 11px;"/>
...
<script>
        $(document).ready(function () {
            ...
            $("#country_id").change(function () {
                ...
                $.ajax({
                    type: "post",
                    url: "<?= base_url("admin/maka_madina_hotels/gatCountryCities") ?>",
