...
<section id="min-wrapper">
    <div id="main-content">
        <div class="container-fluid">
            ...
            <a class="btn btn-sm btn-info pull-right" href="<?= \base_url("admin/departments/add/$branches_id") ?>"><?= $lang['add_new']; ?> </a>
            <br>
            <br>
            <div class="row">
                <div class="col-md-12">
                                ...
                                <table class="table table-bordered table-striped table-bottomless" id="ls-editable-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?= $lang['title_ar']; ?></th>
                                            <?php if (isset($page->company_name)) { ?>
                                        ...
                                        <?php
                                            ...
                                            foreach ($page_list as $page_key => $page) {
                                                ...
                                                <tr id="tr_<?= $page->id; ?>">
                                                    ...
                                                    <td>
                                                        <a href="<?= \base_url('admin/employees/show') . '/' . $page->id; ?>"><?= $lang['employees']; ?></a>
                                                    </td>

                                                    <td class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                                        <a class="btn btn-xs btn-warning" title="<?= $lang['edit']; ?>" href="<?= \base_url('admin/departments/edit') . '/' . $page->id; ?>"><i class="fa fa-pencil-square-o"></i> </a>
...
<script>
                                                                ...
                                                                function state_action_masa(title, id) {
                                                                    ...
                                                                    $.ajax({
                                                                        type: "post",
                                                                        url: "<?= base_url("admin/departments/status") ?>" + "/" + id,
                                                                        success: function (data) {
                                                                            if (data == "yes" || data == "	yes") {
                                                                                $.amaran({
                                                                                    content: {
