<?php
    ...
    if ($type == 1 || $type == "") {
        $ttitla_ar = "اسم الدولة باللغة العربية";
        $ttitla_en = "اسم الدولة باللغة الانجليزية";
    } else {
        $ttitla_ar = "اسم المدينة باللغة العربية";
        $ttitla_en = "اسم المدينة باللغة الانجليزية";
    }
?>
...
<section id="min-wrapper">
    <div id="main-content">
        <div class="container-fluid">
            ...
            <a class="btn btn-sm btn-info pull-right" href="<?= \base_url("admin/places/add/$place_id") ?>"><?= $lang['add_new']; ?> </a>
            <br>
            <br>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?= $lang['places']; ?></h3>
                        </div>
                                        ...
                                        <?php
                                            foreach ($page_list as $page_key => $page) {
                                                ...
                                                <tr id="tr_<?= $page->id; ?>">
                                                    ...
                                                    <?php
                                                    //if ($type == 1 || $type == "") {
                                                    echo "<td><a class=\"btn btn-sm btn-info\" href='" . base_url("admin/places/show/$page_id") . "'>" . $lang['cities'] . " </a></td>";
                                                    // }
                                                    ?>
                                                    <td class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                                        <a class="btn btn-xs btn-warning" title="<?= $lang['edit']; ?>" href="<?= \base_url('admin/places/edit/' . $page->id); ?>"><i class="fa fa-pencil-square-o"></i> </a>
...
<script>
                                                        ...
                                                        function delete_item_masa(title, id) {
                                                            ...
                                                            $.ajax({
                                                                type: "post",
                                                                url: "<?= base_url("admin/places/delete") ?>" + "/" + id,
                                                        ...
                                                        function state_action_masa(title, id) {
                                                            ...
                                                            $.ajax({
                                                                type: "post",
                                                                url: "<?= base_url("admin/places/status") ?>" + "/" + id,
                                                                success: function (data) {
                                                                    ...
                                                                    if (data == "yes") {
                                                                        ...
                                                                        $.amaran({
                                                                            content: {
                                                                                message: '<b> فشل فى  تغيير حالة  العنصر</b>',
                                                                                size: title,
                                                                                file: '<b> </b>',
                                                                                icon: 'fa fa-times'
                                                                            },
