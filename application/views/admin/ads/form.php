            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="<?= \base_url('admin/ads/show') ?>">Ads</a></li>
                    </ol>
                    <!--Top breadcrumb start -->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?= $lang['add'] . " ads" ; ?></h3>
                        </div>
                        <div class="panel-body">
							<?php if (!empty($error)) { ?>
								...
								<?php } ?>
                            <!--Table Wrapper Start-->
                            <form  enctype="multipart/form-data" action="<?= \base_url('admin/ads') . $action; ?>" method="post" class="form-horizontal ls_form form-horizontal ls_form bv-form">
								...
								<?php
									...
									$up_or_down[0] = "   الاول  ";
									$up_or_down[1] = " الثانى";
									if (!isset($edit->up_or_down)) {
										$up_or_down_val = 0;
									} else {
										$up_or_down_val = $edit->up_or_down;
									}
								?>
                                ...
                                <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 col-md-2 col-lg-2 control-label text-capitalize"> الاول ام الثانى</label>
                                    <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
										<?php echo form_dropdown('up_or_down', $up_or_down, $up_or_down_val, 'class="form-control"') ?>
                                    </div>
                                </div>
								...
								<?php if (isset($edit->image)) {
										...
										<div class="form-group">
											...
											<div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
												...
												<img src="<?php echo base_url('uploads/ads/' . $edit->image); ?>" width="200" height="100" />
											</div>						
										</div>
