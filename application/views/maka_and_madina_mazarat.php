<div class="page-head" style="background-repeat: no-repeat;background-position: center top;background-image: url('<?= base_url("assets/front/images/page-title-bg.jpg") ?>'); background-size: cover ">
    <div class="page-head-wrap">
        ...
        <h1 class="page-head-title"><span> المزارات</span></h1>
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="news-wrap">
                ...
                <div class="row">
					<?php
						if (\count($maka_and_madina_mazarat) > 0) {
							foreach ($maka_and_madina_mazarat as $value) {
								?>
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
									<div class="property-item clearfix hvr-float-shadow" data-aos="flip-left">
										<div class="list-property-img">
											<a href="<?= base_url("maka_and_madina_mazarat/detail") . "/" . $value->maka_or_madina . "/" . $value->id . "-" . str_replace(" ", "_", $value->title_ar); ?>">
												<img src="<?= \base_url("uploads/maka_madina_shrines/$value->image") ?>" title="<?= $value->title_ar ?>" alt="<?= $value->title_ar ?>" />
											</a>
										</div>
										<div class="list-property-desc">
											<h4><a href="<?= base_url("maka_and_madina_mazarat/detail") . "/" . $value->maka_or_madina . "/" . $value->id . "-" . str_replace(" ", "_", $value->title_ar); ?>"><?= $value->title_ar ?></a></h4>
											<p><?= \character_limiter(\strip_tags($value->body_ar), 150) ?></p>
											<div class="pro-btn-box">
												<a href="<?= base_url("maka_and_madina_mazarat/detail") . "/" . $value->maka_or_madina . "/" . $value->id . "-" . str_replace(" ", "_", $value->title_ar); ?>" class="pro-ln-mor">التفاصيل</a>
											</div>
										</div>
									</div>
								</div> 
