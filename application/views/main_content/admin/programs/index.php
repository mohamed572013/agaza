            ...
            <div class="modal-body">
                ...
                <form role="form" class="form-horizontal" id="addEditProgramsForm"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label class="col-xs-12 col-sm-4 col-md-4 control-label text-capitalize">E-Travel Gate</label>
                            <div class="col-xs-12 col-sm-8 col-md-8">
                        ...
                        <div class="form-group col-md-6">
                            <label class="col-xs-12 col-sm-4 col-md-4 control-label text-capitalize">program stars</label>
                            <div class="col-xs-12 col-sm-8 col-md-8">
                                <input type="text" min="1" class="form-control" id="stars" name="stars">
                                <div class="help-block"></div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label class="col-xs-12 col-sm-4 col-md-4 control-label text-capitalize">اختر الشركة</label>
                            <div class="col-xs-12 col-sm-8 col-md-8">
                                <select class="form-control"  required="required"   name=" branches_id" id="branches_id">
                                    <option selected disabled>اختر</option>
                                    <?php
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                <input type="text" min="1" class="form-control" id="agaza_this_order" name="agaza_this_order">
                                <div class="help-block"></div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                <input type="text" class="form-control" id="agaza_title_ar" name="agaza_title_ar" value="">
                                <div class="help-block"></div>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                <input type="text" class="form-control" id="agaza_title_en" name="agaza_title_en" value="">
                                <div class="help-block"></div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group row col-md-6">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                <textarea rows="5" class="form-control" name="agaza_program_include_ar" id="agaza_program_include_ar"></textarea>
                                <div class="help-block"></div>
                            </div>
                        </div>
                        <div class="form-group row col-md-6">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                <textarea rows="5" class="form-control" name="agaza_program_include_en" id="agaza_program_include_en"></textarea>
                                <div class="help-block"></div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group row col-md-6">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                <textarea rows="5" class="form-control" name="agaza_desc_ar" id="agaza_desc_ar"></textarea>
                                <div class="help-block"></div>
                            </div>
                        </div>
                        <div class="form-group row col-md-6">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                <textarea rows="5" class="form-control" name="agaza_desc_en" id="agaza_desc_en"></textarea>
                                <div class="help-block"></div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group row col-md-6">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                <textarea rows="5" class="form-control" name="agaza_keywords_ar" id="agaza_keywords_ar"></textarea>
                                <div class="help-block"></div>
                            </div>
                        </div>
                        <div class="form-group row col-md-6">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                <textarea rows="5" class="form-control" name="agaza_keywords_en" id="agaza_keywords_en"></textarea>
                                <div class="help-block"></div>
                            </div>
                        </div>
                    </div>
