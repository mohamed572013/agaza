    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" class="form-horizontal" id="addEditHotelRoomsForm" name="user-form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-4  control-label text-capitalize">عدد الأسرة</label>
                        <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
                            <input type="text" class="form-control" id="no_of_bed" name="no_of_bed">
                            <div class="help-block"></div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li> <?= _lang('hotels'); ?></li>
                        <li class="active"><a href="<?= base_url('admin/hotel_rooms/show'); ?>"><?= _lang('hotel_rooms'); ?></a></li>
                    </ol>
                    <!--Top breadcrumb start -->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?= _lang('hotel_rooms'); ?></h3>
                        </div>
                        <div class="panel-body">
                            <!--Table Wrapper Start-->
                            <a class="btn btn-sm btn-info pull-left" style="margin-bottom: 40px;" href="" onclick="Hotel_rooms.add(); return false;"><?= $lang['add_new']; ?> </a>
...
<?php
    global $_require;
    $_require['js'] = array('hotel_rooms.js');
?>
