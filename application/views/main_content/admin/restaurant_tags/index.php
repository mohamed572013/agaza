            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="<?= base_url('admin/restaurants_tag'); ?>"><?= _lang('restaurants_tag'); ?></a></li>
                    </ol>
                    <!--Top breadcrumb start -->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?= _lang('restaurants_tag'); ?></h3>
                        </div>
                        <div class="panel-body">
                            <!--Table Wrapper Start-->
                            <a class="btn btn-sm btn-info pull-left" style="margin-bottom: 40px;" href="" onclick="Restaurants_tags.add(); return false;"><?= $lang['add_new']; ?> </a>
...
<?php
    global $_require;
    $_require['js'] = array('restaurants_tags.js');
?>
