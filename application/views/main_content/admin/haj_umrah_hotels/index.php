...
<!-- Modal -->
<div class="modal fade" id="addEditHajUmrahHotels" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="addEditHajUmrahHotelsLabel"></h4>
            </div>

            <div class="modal-body">


                <form role="form" class="form-horizontal" id="addEditHajUmrahHotelsForm"  enctype="multipart/form-data">
                    <input type="hidden" name="haj_umrah_hotel_id" id="haj_umrah_hotel_id" value="0">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label class="col-xs-12 col-sm-4 col-md-4 col-lg-4 control-label text-capitalize"><?= $lang['city']; ?></label>
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                    ...
                    <div class="row">
                        <!--                        <div class="form-group col-md-4">
                                                    <label class="col-xs-12 col-sm-4 col-md-4 col-lg-4 control-label text-capitalize">المدينة</label>
                                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                                        <select class="form-control" name="maka_or_madina" id="maka_or_madina">
                                                            <option disabled="disabled"
                                                                    selected>اختر</option>
                                                            <option value="0">مكة</option>
                        ...
                        <div class="form-group col-md-6">
                            <label class="col-xs-12 col-sm-4 col-md-4 col-lg-4 control-label text-capitalize">البعد عن الحرم بالمتر</label>
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                <input type="number" min="1"  class="form-control" id="far_from_campus" name="far_from_campus">
                                <div class="help-block"></div>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group row col-md-6">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                <textarea rows="5" class="form-control" name="body_arr" id="body_arr"></textarea>
                                <div class="help-block"></div>
                            </div>
                        </div>
                        <div class="form-group row col-md-6">
                                        ...
                                        foreach ($hotels_advantages as $value) {
                                            ...
                                            <div class=" col-lg-3">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <input type='checkbox' name='haj_umrah_hotels_advantages_ids[]'  class="icheck-blue" id="<?= 'advantage_' . $value->id ?>" value='<?= $value->id ?>'   style="float: right;margin: 11px;"/>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="ls-editable-table table-responsive ls-table table-box active" style="padding-top: 30px;" id="hotels_table">
                                <a href="" class="btn btn-primary" style="margin:0 15px 30px;" onclick="Haj_umrah_hotels.add_hotels(); return false;">اضافة جديد</a>
...
<?php
    global $_require;
    $_require['js'] = array('haj_umrah_hotels.js');
?>
