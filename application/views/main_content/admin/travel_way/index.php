...
<!-- Modal -->
<div class="modal fade" id="addEditTravelWay" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="aaddEditTravelWayLabel"></h4>
            </div>

            <div class="modal-body">


                <form role="form" class="form-horizontal" id="addEditTravelWayForm" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <!--Table Wrapper Start-->
                            <a class="btn btn-sm btn-info pull-left" style="margin-bottom: 40px;" href="" onclick="Travel_way.add(); return false;"><?= $lang['add_new']; ?> </a>
...
<?php
    global $_require;
    $_require['js'] = array('travel_way.js');
?>
