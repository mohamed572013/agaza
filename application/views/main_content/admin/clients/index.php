...
<!-- Modal -->
<div class="modal fade" id="addEditClients" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="addEditClientsLabel"></h4>
            </div>

            <div class="modal-body">


                <form role="form" class="form-horizontal" id="addEditClientsForm"  enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="<?= \base_url('admin/clients/show') ?>"><?= _lang('clients'); ?></a></li>
                    </ol>
                    <!--Top breadcrumb start -->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="" class="panel-title hotel-data-box" data-type="hotels"><?= _lang('clients'); ?></a>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="ls-editable-table table-responsive ls-table table-box active" style="padding-top: 30px;" id="hotels_table">
                                <a href="" class="btn btn-primary" style="margin:0 15px 30px;" onclick="Clients.add_clients(); return false;">اضافة جديد</a>
