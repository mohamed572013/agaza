    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" class="form-horizontal" id="addEditCurrencyForm" name="user-form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-4  control-label text-capitalize">العلامة</label>
                        <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-4  control-label text-capitalize">القيمة بالجنيه المصرى</label>
                        <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
                            <input type="text" class="form-control" id="amount_le" name="amount_le">
                            <div class="help-block"></div>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <!--Table Wrapper Start-->
                            <a class="btn btn-sm btn-info pull-left" style="margin-bottom: 40px;" href="" onclick="Currency.add(); return false;"><?= $lang['add_new']; ?> </a>
