    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" class="form-horizontal" id="addEditHotelExtraServicesForm" name="user-form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
                            <select class="form-control" name="room_or_person" id="room_or_person">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href=""><?= _lang('hotel_extra_services'); ?></a></li>
                    </ol>
                    <!--Top breadcrumb start -->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?= _lang('hotel_extra_services'); ?></h3>
                        </div>
                        <div class="panel-body">
                            <!--Table Wrapper Start-->
                            <a class="btn btn-sm btn-info pull-left" style="margin-bottom: 40px;" href="" onclick="Hotel_extra_services.add(); return false;"><?= $lang['add_new']; ?> </a>
...
<?php
    global $_require;
    $_require['js'] = array('hotel_extra_services.js');
?>
