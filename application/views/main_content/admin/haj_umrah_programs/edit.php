                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?= $lang['edit'] . " " . _lang('haj_umrah_programs'); ?></h3>
                        </div>
                        <div class="panel-body">
                            <?php if (!empty($error)) { ?>
                                ...
                                <?php } ?>
                            <!--Table Wrapper Start-->
                            <form  enctype="multipart/form-data"  action="<?= \base_url('admin/haj_umrah_programs/') . $action; ?>" method="post" class="form-horizontal ls_form form-horizontal ls_form bv-form">
                                ...
                                <?php
                                    ...
                                    if (isset($edit->program_view_in_home)) {
                                        $program_view_in_home_val = $edit->program_view_in_home;
                                    } else {
                                        $program_view_in_home_val = 0;
                                    }
                                    if (isset($edit->show_in_home_slider)) {
                                        $active_slider_val = $edit->show_in_home_slider;
                                    } else {
                                        $active_slider_val = 0;
                                    }
                                    $active[0] = "  غير مفعل";
                                    ...
                                    if (isset($_POST['active']) && $_POST['active'] >= 0) {
                                        ...
                                        $programs_seasons_val = $_POST['programs_seasons'];
                                        $branches_val = $_POST['branches'];
                                        $programs_levels_val = $_POST['programs_levels'];
                                        $maka_hotel_id_val = $_POST['maka_hotel_id'];
                                        $madina_hotel_id_val = $_POST['madina_hotel_id'];
                                    } else
                                    if (!isset($edit->active)) {
                                        $active_val = 1;
                                        $programs_seasons_val = "";
                                        $branches_val = "";
                                        $programs_levels_val = "";
                                        $maka_hotel_id_val = "";
                                        $madina_hotel_id_val = "";
                                        ...
                                        $programs_seasons_val = $edit->programs_seasons;
                                        $branches_val = $edit->branches;
                                        $programs_levels_val = $edit->programs_levels;
                                        $maka_hotel_id_val = $edit->maka_hotel_id;
                                        $madina_hotel_id_val = $edit->madina_hotel_id;
                                    }
                                ?>
