...
<div class="list-wrapper bg-grey-2">
    <div class="container">
        <div class="programs-main-content">
            ...
            <div class="row">
                <?php $this->load->view('components/programs_search_sidebar'); ?>
                ...
                <div class="col-xs-12 col-sm-8 col-md-9 programs-main-content">
                    ...
                    <div class="grid-content clearfix programs-content">
                        ...
                        <input type="hidden" class="input_search" name="p_city" id="p_city" value="<?= (isset($p_city)) ? $p_city : '' ?>"/>
                        <input type="hidden" class="input_search" name="p_hotel" id="p_hotel" value="<?= (isset($p_hotel)) ? $p_hotel : '' ?>"/>
                        <input type="hidden" class="input_search" name="p_arrive_date" id="p_arrive_date" value="<?= (isset($p_arrive_date)) ? $p_arrive_date : '' ?>"/>
                        <input type="hidden" class="input_search" name="p_departing_date" id="p_departing_date"  value="<?= (isset($p_departing_date)) ? $p_departing_date : '' ?>"/>
                        <?php if ($all_programs) { ?>
                                        ...
                                        <div class="hotel-item style-3 bg-white">
                                            <div class="table-view">
                                                ...
                                                <div class="title hotel-right clearfix cell-view">
                                                    ...
                                                    <a href="<?= site_url('programs/detail/' . $program_title_url . '-' . $all_program->program_id) ?>" class="c-button m-right bg-3 b-40 pro fl">  المزيد ...</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php
    global $_require;
    $_require['js'] = array('programs_search.js');
?>