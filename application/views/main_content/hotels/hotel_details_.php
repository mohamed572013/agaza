                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="home">
                                ...
                                <p><?= $hotel->desc_ar ?></p>
                                <img class="img-responsive" src="<?= $hotel->company_url . 'uploads/maka_madina_hotels/' . $hotel->image ?>" alt="<?= $hotel->title_ar ?>">
                        ...
                        <div class="text-center">
                            <a href="<?= $hotel->company_url . $current_lang . '/' . 'hotels/booking/' . $hotel_id . '/1' ?>" class="col-md-12 button_2">احجز الأن</a>
                        </div>
