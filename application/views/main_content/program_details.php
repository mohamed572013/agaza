                                    ...
                                    <?php if ($program_images) { ?>
                                            <?php foreach ($program_images as $key => $program_image) { ?>
                                                ...
                                                <div class="swiper-slide <?= $class_active ?>" data-val="<?= $key ?>">
                                                    <img class="img-responsive img-full" src="<?= base_url('uploads/programs_slider/' . $program_image->image); ?>" alt="<?= $program_image->title_ar ?>">
                                                </div>
                        ...
                        <div class="simple-tab color-1 tab-wrapper rtl">
                            ...
                            <div class="tabs-content clearfix">
                                <div class="tab-info active">
                                    ...
                                    <img class="left-img" src="<?= base_url('uploads/programs/' . $program_details->image); ?>" alt="<?= $program_details->program_title ?>">
                                ...
                                <div class="tab-info">
                                    <div class="row">
                                        <?php if (!empty($programs_cities_hotels)) { ?>
                                                <?php foreach ($programs_cities_hotels as $program_city_hotel) { ?>
                                                    <div class="col-md-12">
                                                        <div class="col-md-4 fr">
                                                            <img class="right-img img-responsive"  src="<?= base_url('uploads/places/' . $program_city_hotel->place_image); ?>" alt="">
                                                        </div>
                                                        <div class="col-md-8 fr">
                                                            <h5 class="" style="margin-bottom:5px;"><?= $program_city_hotel->place_title ?></h5>
                                                            <p><?= $program_details->place_desc ?></p>
                                                        </div>
                                                    </div>
                                                <?php } ?>
                                            <?php } ?>
                                                ...
                                                <?php foreach ($programs_cities_hotels as $program_city_hotel) { ?>
                                                    <div class="col-md-12" style="height:150px;margin-bottom: 20px;">
                                                        <a data-toggle="modal" data-target="#myModal_hotel">
                                                            <div class="col-md-4 fr">
                                                                <img class="img-responsive"  src="<?= base_url('uploads/maka_madina_hotels/' . $program_city_hotel->hotel_image); ?>" alt="">
                                                            </div>

                                                            <div class="col-md-8 fr">
                                                                <div class="fr">
                                                                    <h5 class="fr m20"><?= $program_city_hotel->hotel_title ?></h5>
                                                                ...
                                                                <p><?= $program_details->hotel_desc ?></p>
                                                            </div>
                                                        </a>
                                                    </div>
                                                <?php } ?>
                                        ...
                                        <div class="col-lg-12">
                                            <form action="#" method="post" id="booking_request_form">
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <a  data-is-employee="" data-is-guest="" href="<?= site_url('programs/booking/' . $program_title_url . '-' . $program_details->program_flight_id) ?>" class="c-button b-40 bg-dr-blue-2  hv-dr-blue-2-o  booking-btn" ><span>احجز الان</span></a>
                                                </div>
            ...
            <div class="col-xs-12 col-md-4">
                <div class="right-sidebar">
                    <div class="detail-logo bg-grey-2">
                        <?php $program_title_url = str_replace(' ', '_', $program_details->program_title) ?>
                        <a style="width: 100%;font-size: 18px;" data-is-employee="" data-is-guest="" href="<?= site_url('programs/booking/' . $program_title_url . '-' . $program_details->program_flight_id) ?>" class="c-button b-40 bg-dr-blue-2  hv-dr-blue-2-o pulse booking-btn" ><span>احجز الان</span></a>
