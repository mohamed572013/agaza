    ...
    <div class="row">
        <aside class="col-md-3 col-sm-3 hidden-xs" id="sidebar">
            <div class="theiaStickySidebar ">
                <a href="http://www.3omra-online.com" target="_blank"><img src="<?= base_url() ?>/adss.jpg" class="img-responsive m20"></a>
                    ...
                    <div class="col-md-12 col-xs-12">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="home">
                               ...
                               <h3><?= $program_details->program_desc ?></h3>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-8 fr">
                                                        ...
                                                        <p><?= mb_substr($city->place_desc_ar,0,250) ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php } ?>
...
<!--                                                <div class="col-md-12" style="height:150px;margin-bottom: 20px;">    -->
                                                    ...
                                                    <a data-toggle="modal" data-target="#myModal_hotel">
                                                        ...
                                                        <div class="col-md-8 col-xs-12 fr">
                                                            ...
                                                            <p><?= mb_substr($hotel->hotel_desc_ar,0,250) ?></p>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
