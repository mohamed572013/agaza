    ...
    <div class="container-fluid print">
        ...
        <div class="main-content rtl">
            ...
            <div class="flight-reservation-info">
                ...
                <div class="col-md-3 fr"><strong>رقم الإستمارة :</strong><?= $reservation_detail[0]->id; ?></div>
                <div class="col-md-2 fr"><strong>كود الإستمارة :</strong><?= $reservation_detail[0]->reservation_code; ?></div>
                <div class="col-md-5 fr"><strong>اسم البرنامج :</strong><?= $program_detail->title_ar ?></div>
                <div class="col-md-2 fr"><strong>كود البرنامج :</strong><?= $program_detail->our_code ?></div>
                <div class="col-md-4 fr"><strong>الفندق :</strong><?= $program_detail->our_code ?></div>
                <div class="col-md-4 fr"><strong>مدة الرحلة :</strong><?= $program_detail->nights + 1 ?></div>
                <div class="col-md-4 fr"><strong>تاريخ الرحلة :</strong><?= $program_dates[0]->going_date ?></div>
            ...
            <div class="reservation-traverllers-number-info">
                ...
                <div class="col-md-3 fr"><strong>سعر الطفل :</strong><?= $program_dates[0]->child_price ?></div>
                <div class="col-md-3 fr"><strong>عدد الرضع :</strong><?= $reservation_detail[0]->no_of_infant ?></div>
                <div class="col-md-3 fr"><strong>سعر الرضيع :</strong><?= $program_dates[0]->infant_price ?></div>
            ...
            <div class="reservation-rooms-reserved-info">
                ...
                <?php
                    ...
                    foreach ($closed_room as $value) {
                        ...
                        ?>
                        <div class="col-md-4 fr"><strong>نوع الغرفة :</strong><?= $value->title_ar ?></div>
                        <div class="col-md-4 fr"><strong>عدد الغرف :</strong><?= $value->no_of_rooms ?></div>
                        <div class="col-md-4 fr"><strong>السعر :</strong><?= $room_price ?></div>
                    <?php } ?>
            ...
            <div class="reservation-services-cards-info">
                ...
                <?php foreach ($reservation_extra_services_card as $value) { ?>
                        <div class="col-md-6 fr"><strong>الاسم :</strong><?= $value->title_ar ?></div>
                        <div class="col-md-6 fr"><strong>السعر :</strong><?= $value->price ?></div>
                    <?php } ?>
            ...
            <div class="reservation-prices">
                ...
                <div class="col-md-12 fr"><strong>اجمالى سعر الحجز :</strong>7000 جنية مصري فقط لاغير</div>
        ...
        <div class="footer">
            <div class="footer-image">
                <img src="<?= base_url("assets/front") ?>/images/header_pdf2.jpg" style="width: 100%;height: 100px;" />
            </div>
        </div>
