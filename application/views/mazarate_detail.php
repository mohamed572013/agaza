...
<div class="page-head" style="background-repeat: no-repeat;background-position: center top;background-image: url('<?= base_url("assets/front/images/page-title-bg.jpg"); ?>'); background-size: cover ">
	<div class="page-head-wrap">
		...
		<div class="page-head-subtitle"><?= $mazarate_detail->title_ar; ?></div>
    </div>
</div>
            ...
            <div class="news-wrap">
				...
				<div id="sectiona" class="tab-pane fade in active">
					<div class="pro-dtl-text">
						...
						<div class="row" >
							<div class="col-lg-12">
								<img style="width: 100%;max-height: 400px" src="<?= \base_url("uploads/maka_madina_shrines/$mazarate_detail->image") ?>" title="<?= $mazarate_detail->title_ar ?>" alt="<?= $mazarate_detail->title_ar ?>" />
							</div>
						</div>
						<div class="clearfix"></div>
						<br/>
						<div>
							<?= $mazarate_detail->body_ar; ?>
						</div>
