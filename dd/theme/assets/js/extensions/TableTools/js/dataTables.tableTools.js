...
TableTools.prototype = {
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		$('#min-wrapper').css('padding-right','0');
		...
		if ( oConfig.sInfo !== "" )
		{
			this.fnInfo( oConfig.sInfo, 2000 );
		}
	...
	"_fnPrintShowNodes": function ( )
	{
	  ...
	  $('#min-wrapper').css('padding-right','200px');
...
TableTools.BUTTONS = {
	...
	"xls": $.extend( {}, TableTools.buttonBase, {
		...
		"sButtonText": '<i class="fa fa-file-excel-o"></i> اكسل',
		"fnClick": function( nButton, oConfig, flash ) {
			this.fnSetText( flash, this.fnGetTableData(oConfig) );
		}
	} ),
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"sButtonText": '<i class="fa fa-copy"></i> نسخ',
		"fnClick": function( nButton, oConfig, flash ) {
			this.fnSetText( flash, this.fnGetTableData(oConfig) );
		},
		"fnComplete": function(nButton, oConfig, flash, text) {
			...
			this.fnInfo( '<h6><i class="fa fa-copy"></i> تم نسخ الجدول</h6>'+
				'<p>تم نسخ '+lines+' صفوف</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6><i class='fa fa-print'></i> وضع الطباعة</h6><p>من فضلك استخدم اختيار الطباعة للمتصفحك لكى "+
		  "تتم عملية الطباعة. اضغط Esc عند الانتهاء</p>",
		"sMessage": null,
		"bShowAll": true,
		"sToolTip": "View print view",
		"sButtonClass": "DTTT_button_print",
		"sButtonText": '<i class="fa fa-print"></i> طباعة',
